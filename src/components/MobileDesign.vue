<template>
  <div class="mobile__container">
    <div class="mobile__info-banner">
      <p>Datos actualizados a las {{ lastUpdate }}</p>
      <span> (El precio se actualiza cada 5 minutos) </span>
    </div>
    ...
    <div class="mobile__table">
      <div class="mobile__table-companies">
        <label :class="currency_type ? 'btn_buy currency_active' : 'btn_buy'"
          >Compra
          <input type="radio" :value="true" v-model="currency_type" />
        </label>
        <label :class="!currency_type ? 'btn_sell currency_active' : 'btn_sell'"
          >Venta
        ...
        >
            ...
            >
                ...
                <div class="currency__data">
                    ...
                    <a target="_blank" class="currency__btn" :href="company.url"
                    >Ir a</a
                    >
                </div>
            </li>
